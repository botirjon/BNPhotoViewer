#
#  Be sure to run `pod spec lint BNPhotoViewer.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = "Botirjon Nasridinov"
  # s.social_media_url   = "http://twitter.com/botirjon"
  ...
  s.source       = { :git => "https://github.com/botirjon/BNPhotoViewer.git", :tag => "0.0.2" }
